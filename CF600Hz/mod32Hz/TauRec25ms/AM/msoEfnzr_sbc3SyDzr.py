...
def mkmsoEnzr(inputSpkFileTuple, temp_degC=37):
...
#    Syn_iIp.connect(True)
    ...
    PhsStrCo = sbCoSpkFile[34:38]
    PhsStrIp = sbIpSpkFile[34:38]
    if (PhsStrCo[0] == 'N'):
    ...
    msoSpkFile = 'msonSpTs3DzrCaCF' + sbCoSpkFile[16:21] + 'IPD' + str(IPD) + 'C' + sbCoSpkFile[29:len(sbCoSpkFile)]
