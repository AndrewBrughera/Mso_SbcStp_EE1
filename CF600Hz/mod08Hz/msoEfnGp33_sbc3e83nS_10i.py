...
#    """
    ...
    nrn.main.gNabar = (1./3.) * 0.0432 * siemens/cm**2  # 0.072
    nrn.main.gKltbar = (1./3.) * 0.0324 * siemens/cm**2 # 0.054
    nrn.main.gHbar = (1./3.) * 0.01296 * siemens/cm**2 # 0.021
    
    nrn.cDend.gNabar = 0.0 * siemens/cm**2
    nrn.cDend.gKltbar = (1./3.) * 0.00132 * siemens/cm**2 # 0.0022
    nrn.cDend.gHbar = (1./3.) * 0.00066 * siemens/cm**2 # 0.0011
    
    nrn.iDend.gNabar = 0.0 * siemens/cm**2
    nrn.iDend.gKltbar = (1./3.) * 0.00132 * siemens/cm**2 # 0.0022
    nrn.iDend.gHbar = (1./3.) * 0.00066 * siemens/cm**2 # 0.0011
...
#    Syn_iIp.connect(True)
    ...
    #msoSpkFile = 'msonSpTs3D' + sbCoSpkFile[12:19] + 'StIPDn90C' + sbCoSpkFile[26:len(sbCoSpkFile)]
    ...
    while (len(IPDstr) < 3):
        IPDstr = '0' + IPDstr
    msoSpkFile = 'msoGp33s383i10CF' + sbCoSpkFile[14:19] + 'StIPD' + IPDstr + 'C' + sbCoSpkFile[26:len(sbCoSpkFile)]
